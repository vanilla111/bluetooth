...
CREATE TABLE `zh_answer` (
  ...
  `exciting` int(10) unsigned DEFAULT '0',
  `naive` int(10) unsigned DEFAULT '0',
...
-- ----------------------------
-- Table structure for zh_exciting_answer
-- ----------------------------
DROP TABLE IF EXISTS `zh_exciting_answer`;
CREATE TABLE `zh_exciting_answer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL,
...
-- ----------------------------
-- Table structure for zh_exciting_question
-- ----------------------------
DROP TABLE IF EXISTS `zh_exciting_question`;
CREATE TABLE `zh_exciting_question` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL,
  `qid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Table structure for zh_favorite
-- ----------------------------
...
-- ----------------------------
-- Table structure for zh_naive_answer
-- ----------------------------
DROP TABLE IF EXISTS `zh_naive_answer`;
CREATE TABLE `zh_naive_answer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL,
  `aid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Table structure for zh_naive_question
-- ----------------------------
DROP TABLE IF EXISTS `zh_naive_question`;
CREATE TABLE `zh_naive_question` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL,
  `qid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Table structure for zh_person
-- ----------------------------
DROP TABLE IF EXISTS `zh_person`;
